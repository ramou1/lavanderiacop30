        ...
        >
          <div className="mx-auto max-w-6xl">
            ...
            <div
              ...
              <p className="mt-2 text-sm font-medium text-brand-blue/75">
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-4 p-5">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-base font-medium text-brand-blue/70">
                          {machine.kg}
                        </p>
                        <div className="mt-2">
                          <p className="text-xs font-semibold uppercase text-brand-lime">
                            Valor promocional
                          </p>
                          <p className="text-3xl font-bold leading-tight text-brand-blue">
                            {machine.price}{" "}
                            <span className="text-sm font-medium text-brand-blue/60">
                              por ciclo
                            </span>
                          </p>
                        </div>
